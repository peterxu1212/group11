...
with open('../t3_results_w_wf_compare.txt','w', buffering=1) as fout_t2r:
    ...
    for word_file_name in ("words", "words_60", "words_160", "words_60_wo_punctuation", "words_160_wo_punctuation", "words_60_wo_stopwords", "words_160_wo_stopwords", "words_60_adv", "words_160_adv"):
        ...
        #X_validation_set_Adv, Y_validation_set_Adv = pf.generate_wordfeature_and_output(wordcount, data, False, 0, False, 0)
        X_testing_set_Adv, Y_testing_set_Adv, str_output = pf.generate_wordfeature_and_output(wordcount, data_testing_set, b_with_wf, i_len_word_feature, False, 0, b_without_punctuation, False, False, False, False, b_without_stopwords)
