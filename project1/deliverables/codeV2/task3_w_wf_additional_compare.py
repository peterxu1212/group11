...
with open('../task3_w_wf_additional_compare.txt','w', buffering=1) as fout_t2r:
    ...
    for b_without_punctuation in (False, True):
        ...
        for b_without_stopwords in (False, True):
            ...
            for feature_setting in ("0_0_0_0", "1_0_0_0", "0_1_0_0", "0_0_1_0", "0_0_0_1"):
                ...
                X_training_set_Adv, Y_training_set_Adv, str_out = pf.generate_wordfeature_and_output(wordcount, data_training_set, b_with_word_count_feature, i_word_count_feature_count, b_with_Advanced_feature, i_Advanced_feature_count, b_without_punctuation, b_with_total_comment_word_number_feature, b_with_total_number_of_sentence_feature, b_with_average_word_per_sentence_feature, b_with_average_length_per_word_feature, b_without_stopwords)
    ...
    with open("../task3_w_wf_additional_compare_stat.json", "w") as wf_json_set:
