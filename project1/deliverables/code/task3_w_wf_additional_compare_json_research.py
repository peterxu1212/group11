...
with open("../task3_w_wf_additional_compare_stat.json", "r") as read_file:
...
data_set_partial_sorted = sorted(data_set_partial, key=lambda x: (x['mse_for_validation'], x['b_with_average_word_per_sentence_feature']), reverse=True)
