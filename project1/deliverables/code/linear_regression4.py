...
def gradient_descent_linear_regression_alg(in_X, in_Y, epsilon = 10**-6, eta_0 = 10**-1, distance_rate_power=4.0, T_Robbins_Monroe=100):
...
def gradient_descent_linear_regression_alg_old(in_X, in_Y, epsilon = 10**-6, eta_0 = 10**-1, T_Robbins_Monroe=100):
